...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Checklist.completed'
        db.add_column('checklist_checklist', 'completed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Checklist.completed'
        db.delete_column('checklist_checklist', 'completed')
