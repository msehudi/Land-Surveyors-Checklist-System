...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('checklist_site', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.name'
        db.delete_column('checklist_site', 'name')
