...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('checklist_assignment', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.approved'
        db.delete_column('checklist_assignment', 'approved')
