...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistItem.user'
        db.add_column('checklist_checklistitem', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)

        # Changing field 'Checklist.created_date'
        db.alter_column('checklist_checklist', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Deleting field 'ChecklistItem.user'
        db.delete_column('checklist_checklistitem', 'user_id')

        # Changing field 'Checklist.created_date'
        db.alter_column('checklist_checklist', 'created_date', self.gf('django.db.models.fields.DateTimeField')())
