...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Assignment.completed'
        db.delete_column('checklist_assignment', 'completed')

        # Adding field 'Assignment.submitted'
        db.add_column('checklist_assignment', 'submitted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Assignment.completed'
        db.add_column('checklist_assignment', 'completed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Assignment.submitted'
        db.delete_column('checklist_assignment', 'submitted')
